    ...
    <form action="/admin/movies/{{$movie->id}}/update" method="post" class="">
        ...
        <div class="mb-6 w-4/5">
            ...
            <input type="text" id="image_url"
                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                name="image_url" value="{{ old('image_url') }} {{ $movie->image_url}}">
        </div>
        <div class="mb-6 w-4/5">
            ...
            <input type="text" id="published_year"
                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                name="published_year" value="{{ old('published_year') }} {{$movie->published_year}}">
        </div>
        <div class="w-4/5 mb-6">
            ...
            <select id="is_showing"
                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                name="is_showing" value="{{ old('is_showing') }} {{ $movie->is_showing}}">
                <option selected>
                    @if (old('is_showing'))
                        上映中
                    @else
        ...
        <div class="w-4/5 mb-6">
            ...
            <textarea id="description" rows="4"
                ...
                placeholder="Write your thoughts here..." name="description">{{ old('description') }} {{$movie->description}}</textarea>
        </div>
        <div class="mb-6 w-4/5">
            @error('genre')
                <div class="p-4 mb-4 text-sm text-red-800 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400" role="alert">
            ...
            <input type="text" id="genre"
                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                name="genre"  value="@if(!is_null($movie->genre)) {{$movie->genre->name}} @endif">
        </div>
        <div>
            <button type="submit"
