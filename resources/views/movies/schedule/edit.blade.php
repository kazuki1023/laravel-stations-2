...
@section('content')
    <form action="/admin/scheduless/{{ $schedules->id }}/update" method="post" class="">
      ...
      <div class="flex justify-center text-center w-4/5">
        <button type="submit" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">更新</button>
      </div>
    </form>
@endsection
