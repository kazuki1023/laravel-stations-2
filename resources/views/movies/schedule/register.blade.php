...
@section('content')
    <form action="/admin/movies/{{$movie_id}}/schedules/store" method="POST" class="">
        @csrf
        <div class="mb-6 w-4/5">
            ...
            <input type="text" id="movie_id" aria-label="disabled input 2"
                ...
                value="{{ old('movie_id') }} {{ $movie_id}}" disabled readonly name="movie_id" required>
        </div>
        <div class=" mb-6 w-4/5 relative ">
            ...
            <input datepicker datepicker-autohide datepicker-format="yyyy-mm-dd" type="text"
                ...
                placeholder="開始日付" name="start_time_date" value='' required>
        </div>
        <div class="mb-6 w-4/5 relative" data-te-timepicker-init data-te-input-wrapper-init>
            ...
            <input type="text"
                ...
                id="start_time_time" name="start_time_time" value="" required/>
        ...
        <div class="relative mb-6 w-4/5">
            ...
            <input datepicker datepicker-autohide datepicker-format="yyyy-mm-dd" type="text"
                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                placeholder="開始日付" name="end_time_date" value="" required>
        </div>
        <div class="mb-6 w-4/5 relative" data-te-timepicker-init data-te-input-wrapper-init>
            @error('end_time_time')
                <div class="p-4 mb-4 text-sm text-red-800 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400"
            ...
            <input type="text"
                class="peer block min-h-[auto] w-full rounded border-0 bg-transparent px-3 py-[0.32rem] leading-[1.6] outline-none transition-all duration-200 ease-linear focus:placeholder:opacity-100 peer-focus:text-primary data-[te-input-state-active]:placeholder:opacity-100 motion-reduce:transition-none dark:text-neutral-200 dark:placeholder:text-neutral-200 dark:peer-focus:text-primary [&:not([data-te-input-placeholder-active])]:placeholder:opacity-0"
                id="end_time_time" name="end_time_time" value="" required/>
